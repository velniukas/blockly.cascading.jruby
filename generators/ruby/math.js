...
Blockly.Ruby.addReservedWords('math,random');

Blockly.Ruby.math_number = function() {
  // Numeric value.
...
Blockly.Ruby.math_arithmetic = function() {
  // Basic arithmetic operators, and power.
  var mode = this.getTitleValue('OP');
  var tuple = Blockly.Ruby.math_arithmetic.OPERATORS[mode];
  ...
  // in Ruby 2 and 3. However, is not an issue since Blockly does not
...
Blockly.Ruby.math_arithmetic.OPERATORS = {
...
Blockly.Ruby.math_single = function() {
  ...
  if (operator == 'NEG') {
    ...
    var code = Blockly.Ruby.valueToCode(this, 'NUM',
        Blockly.Ruby.ORDER_UNARY_SIGN) || '0';
    return ['-' + code, Blockly.Ruby.ORDER_UNARY_SIGN];
  }
  Blockly.Ruby.definitions_['import_math'] = 'import math';
  if (operator == 'SIN' || operator == 'COS' || operator == 'TAN') {
    arg = Blockly.Ruby.valueToCode(this, 'NUM',
...
Blockly.Ruby.math_constant = function() {
  // Constants: PI, E, the Golden Ratio, sqrt(2), 1/sqrt(2), INFINITY.
  var constant = this.getTitleValue('CONSTANT');
  if (constant != 'INFINITY') {
    Blockly.Ruby.definitions_['import_math'] = 'import math';
  }
  return Blockly.Ruby.math_constant.CONSTANTS[constant];
};

Blockly.Ruby.math_constant.CONSTANTS = {
  ...
  SQRT1_2: ['math.sqrt(1 / 2)', Blockly.Ruby.ORDER_MEMBER],
  INFINITY: ['float(\'inf\')', Blockly.Ruby.ORDER_ATOMIC]
};

Blockly.Ruby.math_number_property = function() {
  // Check if a number is even, odd, prime, whole, positive, or negative
  // or if it is divisible by certain number. Returns true or false.
  var number_to_check = Blockly.Ruby.valueToCode(this, 'NUMBER_TO_CHECK',
  ...
  if (dropdown_property == 'PRIME') {
    ...
    if (!Blockly.Ruby.definitions_['isPrime']) {
      ...
      func.push('      return False');
      func.push('  return True');
      Blockly.Ruby.definitions_['isPrime'] = func.join('\n');
    }
    code = Blockly.Ruby.logic_prime + '(' + number_to_check + ')';
    return [code, Blockly.Ruby.ORDER_FUNCTION_CALL];
  }
  switch (dropdown_property) {
    ...
    case 'NEGATIVE':
      ...
      break;
    case 'DIVISIBLE_BY':
      var divisor = Blockly.Ruby.valueToCode(this, 'DIVISOR',
          Blockly.Ruby.ORDER_MULTIPLICATIVE);
...
Blockly.Ruby.math_change = function() {
  // Add to a variable in place.
  var argument0 = Blockly.Ruby.valueToCode(this, 'DELTA',
...
Blockly.Ruby.math_on_list = function() {
  ...
  switch (func) {
    ...
    case 'MAX':
      ...
      break;
    case 'AVERAGE':
      if (!Blockly.Ruby.definitions_['math_mean']) {
        // This operation exclude null and values that are not int or float:
        //   math_mean([null,null,"aString",1,9]) == 5.0.
        var functionName = Blockly.Ruby.variableDB_.getDistinctName(
            'math_mean', Blockly.Generator.NAME_TYPE);
        Blockly.Ruby.math_on_list.math_mean = functionName;
        var func = [];
        ...
        Blockly.Ruby.definitions_['math_mean'] = func.join('\n');
      }
      code = Blockly.Ruby.math_on_list.math_mean + '(' + list + ')';
      break;
    case 'MEDIAN':
      if (!Blockly.Ruby.definitions_['math_median']) {
        // This operation exclude null values:
        //   math_median([null,null,1,3]) == 2.0.
        var functionName = Blockly.Ruby.variableDB_.getDistinctName(
            'math_median', Blockly.Generator.NAME_TYPE);
        Blockly.Ruby.math_on_list.math_median = functionName;
        var func = [];
        func.push('def ' + functionName + '(myList):');
        ...
        Blockly.Ruby.definitions_['math_median'] = func.join('\n');
      }
      code = Blockly.Ruby.math_on_list.math_median + '(' + list + ')';
      break;
    case 'MODE':
      if (!Blockly.Ruby.definitions_['math_modes']) {
        // As a list of numbers can contain more than one mode,
        // the returned result is provided as an array.
        // Mode of [3, 'x', 'x', 1, 1, 2, '3'] -> ['x', 1].
        var functionName = Blockly.Ruby.variableDB_.getDistinctName(
            'math_modes', Blockly.Generator.NAME_TYPE);
        Blockly.Ruby.math_on_list.math_modes = functionName;
        var func = [];
        ...
        Blockly.Ruby.definitions_['math_modes'] = func.join('\n');
      }
      code = Blockly.Ruby.math_on_list.math_modes + '(' + list + ')';
      break;
    case 'STD_DEV':
      if (!Blockly.Ruby.definitions_['math_standard_deviation']) {
        Blockly.Ruby.definitions_['import_math'] = 'import math';
        var functionName = Blockly.Ruby.variableDB_.getDistinctName(
            'math_standard_deviation', Blockly.Generator.NAME_TYPE);
        Blockly.Ruby.math_on_list.math_standard_deviation = functionName;
        var func = [];
        ...
        Blockly.Ruby.definitions_['math_standard_deviation'] =
            func.join('\n');
      }
      code = Blockly.Ruby.math_on_list.math_standard_deviation +
          '(' + list + ')';
      break;
    case 'RANDOM':
...
Blockly.Ruby.math_modulo = function() {
  // Remainder computation.
  var argument0 = Blockly.Ruby.valueToCode(this, 'DIVIDEND',
      Blockly.Ruby.ORDER_MULTIPLICATIVE) || '0';
  var argument1 = Blockly.Ruby.valueToCode(this, 'DIVISOR',
      Blockly.Ruby.ORDER_MULTIPLICATIVE) || '0';
  var code = argument0 + ' % ' + argument1;
  return [code, Blockly.Ruby.ORDER_MULTIPLICATIVE];
};

Blockly.Ruby.math_constrain = function() {
  // Constrain a number between two limits.
  var argument0 = Blockly.Ruby.valueToCode(this, 'VALUE',
      Blockly.Ruby.ORDER_NONE) || '0';
  var argument1 = Blockly.Ruby.valueToCode(this, 'LOW',
      Blockly.Ruby.ORDER_NONE) || '0';
  var argument2 = Blockly.Ruby.valueToCode(this, 'HIGH',
...
Blockly.Ruby.math_random_int = function() {
  // Random integer between [X] and [Y].
  Blockly.Ruby.definitions_['import_random'] = 'import random';
  var argument0 = Blockly.Ruby.valueToCode(this, 'FROM',
      Blockly.Ruby.ORDER_NONE) || '0';
  var argument1 = Blockly.Ruby.valueToCode(this, 'TO',
      Blockly.Ruby.ORDER_NONE) || '0';
  var code = 'random.randint(' + argument0 + ', ' + argument1 + ')';
  return [code, Blockly.Ruby.ORDER_FUNCTION_CALL];
};

Blockly.Ruby.math_random_float = function() {
  // Random fraction between 0 and 1.
  Blockly.Ruby.definitions_['import_random'] = 'import random';
  return ['random.random()', Blockly.Ruby.ORDER_FUNCTION_CALL];
};
